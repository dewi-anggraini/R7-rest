class Api::V1::FactsController < ApplicationController
    ...
    def index
      @member = Member.find(params[:member_id]) # note that because the facts route is nested inside members
      render json: @member.facts # we return only the facts belonging to that member
    end 
                             
    # GET /members/:member_id/facts/:id
    def show
      render json: @fact  # your code goes here
    end
